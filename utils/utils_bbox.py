...
class DecodeBox():
    """Decode model outputs and apply post-processing in PyTorch."""

    def __init__(self, anchors, num_classes, input_shape, anchors_mask = [[6,7,8], [3,4,5], [0,1,2]]):
        """Store anchors and output dimensions for PyTorch decoding."""
    ...
    def decode_box(self, inputs):
        """Decode raw feature-map outputs into normalized boxes and scores."""
        outputs = []
    ...
    def correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        """Map decoded boxes from network input space back to image space."""
        box_yx = box_xy[..., ::-1]
        box_hw = box_wh[..., ::-1]
    ...
    def non_max_suppression(self, prediction, num_classes, input_shape, image_shape, letterbox_image, conf_thres=0.5, nms_thres=0.4):
        """Filter detections by confidence and class-wise NMS."""
...
class DecodeBoxNP():
    """NumPy implementation of box decoding and post-processing."""

    def __init__(self, anchors, num_classes, input_shape, anchors_mask = [[6,7,8], [3,4,5], [0,1,2]]):
        """Store anchors and output dimensions for NumPy decoding."""
    ...
    def sigmoid(self, x):
        """Apply sigmoid activation to a NumPy array."""
        return 1 / (1 + np.exp(-x))

    def decode_box(self, inputs):
        """Decode raw NumPy outputs into normalized boxes and scores."""
        outputs = []
        for i, input in enumerate(inputs):
    ...
    def correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        """Map decoded NumPy boxes from input space back to image space."""
        box_yx = box_xy[..., ::-1]
        box_hw = box_wh[..., ::-1]
        input_shape = np.array(input_shape)
        image_shape = np.array(image_shape)
    ...
    def non_max_suppression(self, prediction, num_classes, input_shape, image_shape, letterbox_image, conf_thres=0.5, nms_thres=0.4):
        """Filter NumPy detections by confidence and class-wise NMS."""
...
if __name__ == "__main__":
    ...
    def get_anchors_and_decode(input, input_shape, anchors, anchors_mask, num_classes):
        """Decode one feature map for the standalone visualization block."""
